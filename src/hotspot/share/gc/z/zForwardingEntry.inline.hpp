...
inline const bool ZCompactForwardingEntry::get_partial(size_t index) const {
  return ((1ULL) << index) & (_entry >> 50);
}
...
// Z live map
//
//                 100 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000
// XX11 1111 1111 11YY YYYY YYYY YYYY YYYY ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ
inline void ZCompactForwardingEntry::set_partial(size_t index) {
  assert(!get_partial(index), "");
  size_t p = 1ULL << (index + 50);
  _entry |= p;
  assert(get_partial(index), "");
}
