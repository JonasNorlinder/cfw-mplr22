...
This repository contains the code used in the paper [Compressed Forwarding Tables Reconsidered](http://url_to_paper), which explores a design that guarantees a low memory bound for forwarding information used by the GC. The design is evaluated on-top of generational ZGC.
...
* [Compare CFW with baseline generational ZGC](https://github.com/JonasNorlinder/cfw-mplr22/compare/zgc_generational...cfw)
* [Compare coalesce optimization with CFW](https://github.com/JonasNorlinder/cfw-mplr22/compare/cfw...cfw_coalesce)
* [Compare partial ordinal optimization with CFW](https://github.com/JonasNorlinder/cfw-mplr22/compare/cfw...cfw_partial_ordinal)
* [Compare partial vector array optimization with CFW](https://github.com/JonasNorlinder/cfw-mplr22/compare/cfw...cfw_partial_vector_array)
* [Compare partial inline vector optimization with CFW](https://github.com/JonasNorlinder/cfw-mplr22/compare/cfw...cfw_partial_vector_inline)

Note that baseline generational ZGC is branched from [openjdk/zgc/1bfcf4f](https://github.com/openjdk/zgc/commit/1bfcf4fe4ee6243bac9cff0f828bb418bd843e6f). A small patch is applied on the baseline in order to measure in bytes instead of megabytes to avoid truncation.
